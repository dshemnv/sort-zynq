...
void kalmanfilter_accel(ap_uint<32> *in_A, ap_uint<32> *in_Uq,
                        ap_uint<32> *in_Dq, ap_uint<32> *in_H,
                        ap_uint<32> *in_X0, ap_uint<32> *in_U0,
                        ap_uint<32> *in_D0, ap_uint<32> *in_R,
                        ap_uint<32> *in_u, ap_uint<32> *in_y,
                        unsigned char control_flag, ap_uint<32> *out_X,
                        ap_uint<32> *out_U, ap_uint<32> *out_D) {
    // clang-format off
    ...
    xf::cv::accel_utils obj_inA, obj_inUq, obj_inU0, obj_inH;
    xf::cv::accel_utils obj_inDq, obj_inX0, obj_inD0, obj_inR, obj_iny;
    xf::cv::accel_utils obj_outU, obj_outD, obj_outX;
    ...
    // Run xfOpenCV kernel:
    xf::cv::KalmanFilter<KF_N, KF_M, KF_C, KF_MTU, KF_MMU, XF_USE_URAM, 0, TYPE,
                         NPC1>(A_mat, Uq_mat, Dq_mat, H_mat, X0_mat, U0_mat,
                               D0_mat, R_mat, y_mat, Xout_mat, Uout_mat,
                               Dout_mat, control_flag);
